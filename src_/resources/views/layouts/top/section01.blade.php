                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-7 col-md-9 ">
                        <div class="hero__caption">
                            <h1 data-animation="fadeInLeft" data-delay=".4s">-- Chartman --><br>
                            <font size="6">We Can Explosive Flowcharting!!</font></h1>
                            ...
                            <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s">
                                <a href="industries.html" class="btn hero-btn">Make Flowchart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
